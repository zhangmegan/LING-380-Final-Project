# -*- coding: utf-8 -*-
"""French-Turkish_FineTuning.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1LSf1pCTObUBqzCRZOG12U9gQZkQE5cET
...
model_path = '/content/gdrive/My Drive/mt5_translationNEW4.pt'
...
dataset_en_fr2 = dataset_en_fr['train']
dataset_en_tr2 = dataset_en_tr['train']

dataset_fr = dataset_en_fr2.train_test_split(0.42)
dataset_fr = dataset_fr['test']
dataset_fr = dataset_fr.train_test_split(0.1)
...
dataset_tr = dataset_en_tr2.train_test_split(0.0167)
...
lr = 5e-4
n_batches = int(np.ceil(len(train_fr) / batch_size))
...
for epoch_idx in range(n_epochs):
   ...
   data_generator = get_data_generator(train_fr, LANG_TOKEN_MAPPING, #changed it here
                                       tokenizer, batch_size)
   ...
   for batch_idx, (input_batch, label_batch) \
     ...
     if (batch_idx + 1) % checkpoint_freq == 0:
       test_loss = eval_model(model, test_fr)
